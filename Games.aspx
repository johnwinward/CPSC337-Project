    ...
    <form runat="server">
        <div class="row text-center">
            <div class="col-12">
                ...
                <asp:DropDownList ID="ConsolesDropDown" runat="server" AutoPostBack="true" DataSourceID="SQLConsoles" DataTextField="ConsoleName" DataValueField="ConsoleID" OnSelectedIndexChanged="ClearSelected" CssClass="ConsolesDropDown">
                </asp:DropDownList>
            </div>
